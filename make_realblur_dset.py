...
def main():
    ...
    args_parser.add_argument('--save_dir', '-s', type=str, help='Dir (relative to cwd) to save images',
                             default=r'D:/Projects/datasets/RealBlur/processed')
    ...
    save_dir_train = Path(args.save_dir) / 'train' / f'awgn-{args.min_noise_std}-{args.max_noise_std}'
    ...
    save_dir_test = Path(args.save_dir) / 'test' / f'awgn-{args.min_noise_std}-{args.max_noise_std}'
